...
<div class="navbar navbar-default ">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="./Teaching.php">
...
<div class="container">
        <strong><font size="5">Teaching Assistantship at Concordia University:</strong></font>
        <br>
        <br>
        <ul>
            <li> <a href="COEN6541.php"> COEN6541 Hardware functional Verification</a> </li>
            <li> <a href="COEN6711.php"> COEN6711 Microprocessors and their applications</a> </li>
            <li> COEN313 Digital System Design II</li>
            <li> COEN311 Computer organization and software</li>
            <li> COEN212 Digital System Design I</li>
        </ul>
</div>
